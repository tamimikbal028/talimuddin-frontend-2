...
const Login = () => {
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center gap-8 overflow-auto bg-gray-100 px-4 py-10 lg:flex-row lg:gap-15">
      {/* Header - Top on mobile, Left on desktop */}
      <div className="text-center">
        <h1 className="mb-2 text-3xl font-bold text-gray-900 sm:text-4xl">Talimuddin</h1>
